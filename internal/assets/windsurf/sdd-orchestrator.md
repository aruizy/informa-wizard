...
Native Windsurf Workflow: `/sdd-new` is also available as a native Windsurf workflow installed by informa-wizard. It can be triggered from the Windsurf workflow panel.
