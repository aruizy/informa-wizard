...
1. Check `~/.informa-wizard/monday.json` (global wizard config) for `{"token": "...", "board_id": "..."}`, OR
2. Check `.informa-wizard/monday.json` in the workspace root for project-specific override, OR
