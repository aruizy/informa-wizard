...
For this agent (inline subagents): definition phases invoke subagents sequentially without pausing unless a halt condition is reported. The orchestrator evaluates each subagent's output before invoking the next.
