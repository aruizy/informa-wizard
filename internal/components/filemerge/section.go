...
const (
	markerPrefix = "<!-- informa-wizard:"
	markerSuffix = " -->"
	closePrefix  = "<!-- /informa-wizard:"
)
...
// written to a markdown file outside of <!-- informa-wizard: --> markers.
//
...
// <!-- informa-wizard: --> marker). A fingerprint that exists only inside a marker
...
// written by the standalone ATL installer before informa-wizard superseded it.
...
// <!-- informa-wizard:sdd-orchestrator --> section, so keeping both wastes ~150
...
// Markers use HTML comments: <!-- informa-wizard:SECTION_ID --> ... <!-- /informa-wizard:SECTION_ID -->
