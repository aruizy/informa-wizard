...
func TestInjectClaudeGentlemanWritesSectionWithRealContent(t *testing.T) {
	...
	text := string(content)
	if !strings.Contains(text, "<!-- informa-wizard:persona -->") {
...
func TestInjectOpenCodeNeutralPreservesManagedSections(t *testing.T) {
	...
	if !strings.Contains(text, "<!-- informa-wizard:engram-protocol -->") {
...
func TestInjectNeutralPreservesWhenMarkerAtByteZero(t *testing.T) {
	...
	markerOnly := "<!-- informa-wizard:sdd-orchestrator -->\nSDD content\n<!-- /informa-wizard:sdd-orchestrator -->\n"
...
func TestInjectNeutralIdempotentWithManagedSections(t *testing.T) {
	...
	if strings.Count(text, "<!-- informa-wizard:sdd-orchestrator -->") != 1 {
...
func TestInjectClaudeAutoHealsStaleFreeTextPersona(t *testing.T) {
	...
	if !strings.Contains(text, "<!-- informa-wizard:sdd -->") {
	...
	if firstPersonaIdx != lastPersonaIdx {
		...
		openMarkerIdx := strings.Index(text, "<!-- informa-wizard:persona -->")
