...
func TestInjectClaudeWritesSectionMarkers(t *testing.T) {
	...
	if !strings.Contains(text, "<!-- informa-wizard:sdd-orchestrator -->") {
...
func TestInjectClaudeCustomModelAssignments(t *testing.T) {
	...
	if !strings.Contains(text, "<!-- informa-wizard:sdd-model-assignments -->") {
...
func TestInjectFileAppendMigratesFullLegacyOrchestratorBlock(t *testing.T) {
	...
	existing := "## Rules\n\nLegacy intro.\n\n" +
		...
		"<!-- informa-wizard:engram-protocol -->\n" +
	...
	if strings.Count(text, "<!-- informa-wizard:engram-protocol -->") != 1 {
...
func TestStripBareOrchestratorSection_DoesNotStripIfMarkersPresent(t *testing.T) {
	...
	// the `!strings.Contains(existing, "<!-- informa-wizard:sdd-orchestrator -->")` guard
...
// the <!-- informa-wizard:strict-tdd-mode --> marker with its content.
func TestInjectStrictTDDEnabledInjectsMarkerIntoClaude(t *testing.T) {
	...
	text := string(content)
	if !strings.Contains(text, "<!-- informa-wizard:strict-tdd-mode -->") {
		t.Fatal("CLAUDE.md missing <!-- informa-wizard:strict-tdd-mode --> open marker")
	}
	if !strings.Contains(text, "<!-- /informa-wizard:strict-tdd-mode -->") {
		t.Fatal("CLAUDE.md missing <!-- /informa-wizard:strict-tdd-mode --> close marker")
	}
...
func TestInjectClaudeDoesNotStripMarkedSection(t *testing.T) {
	...
	if !strings.Contains(string(after1), "<!-- informa-wizard:sdd-orchestrator -->") {
...
func TestInjectWindsurf_WorkflowsFoundFromSubdirectory(t *testing.T) {
	...
	// Simulate running informa-wizard from a subdirectory inside that project.
