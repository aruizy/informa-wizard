---
name: informa-wizard-issue-creation
description: >
...
- Open any GitHub issue on the [Gentleman-Programming/informa-wizard](https://github.com/Gentleman-Programming/informa-wizard) repository
...
4. **Questions go to Discussions** — use [GitHub Discussions](https://github.com/Gentleman-Programming/informa-wizard/discussions), NOT issues, for questions and general conversation.
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/Gentleman-Programming/informa-wizard/issues
...
```bash
gh issue create \
  --repo Gentleman-Programming/informa-wizard \
...
```
https://github.com/Gentleman-Programming/informa-wizard/issues/new?template=bug_report.yml
```
...
Or open the web form directly:
```
https://github.com/Gentleman-Programming/informa-wizard/issues/new?template=feature_request.yml
```
...
│         https://github.com/Gentleman-Programming/informa-wizard/discussions
...
```bash
# Search open issues
gh issue list --repo Gentleman-Programming/informa-wizard --state open --search "your keywords"

# Search all issues including closed
gh issue list --repo Gentleman-Programming/informa-wizard --state all --search "your keywords"
```
...
```bash
gh issue view <number> --repo Gentleman-Programming/informa-wizard
```
