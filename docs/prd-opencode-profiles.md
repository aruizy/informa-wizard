...
**R-PROF-23**: El prompt del orchestrator (`orchestrator.md`) DEBE incluir un bloque `<!-- informa-wizard:sdd-model-assignments -->` que se inyecta dinámicamente con la tabla de modelos de ESE perfil específico.
...
```bash
informa-wizard sync --profile cheap:anthropic/claude-haiku-3.5-20241022
```
